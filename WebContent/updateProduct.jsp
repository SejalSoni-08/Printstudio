				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="mobile"
								<%="mobile".equalsIgnoreCase(ptype) ? "selected" : ""%>>LANYARDS</option>
							<option value="tv"
								<%="tv".equalsIgnoreCase(ptype) ? "selected" : ""%>>CAPS</option>
							<option value="camera"
								<%="camera".equalsIgnoreCase(ptype) ? "selected" : ""%>>T-SHIRTS</option>
							<option value="laptop"
								<%="laptop".equalsIgnoreCase(ptype) ? "selected" : ""%>>MUGS</option>
							<option value="tablet"
								<%="tablet".equalsIgnoreCase(ptype) ? "selected" : ""%>>BADGES</option>
							<option value="speaker"
								<%="speaker".equalsIgnoreCase(ptype) ? "selected" : ""%>>CLOTH-BAGS</option>
							<option value="other"
								<%="other".equalsIgnoreCase(ptype) ? "selected" : ""%>>SOME OTHER PRODUCTS
				</option>
						</select>
					</div>
				</div>

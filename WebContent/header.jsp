...
<body style="background-color: #fff2cc;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #f0902b; color: white; padding: 5px;">
		<h2>Print Studio</h2>
		<h6>Customize your own Design...</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Print Studio</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=lanyards">LANYARDS</a></li>
							<li><a href="index.jsp?type=caps">CAPS</a></li>
							<li><a href="index.jsp?type=t-shirts">T-SHIRTS</a></li>
							<li><a href="index.jsp?type=mugs">MUGS</a></li>
							<li><a href="index.jsp?type=badges">BADGES</a></li>
							<li><a href="index.jsp?type=cloth-bags">CLOTH-BAGS</a></li>
							<li><a href="index.jsp?type=other">SOME OTHER PRODUCTS</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=lanyards">LANYARDS</a></li>
							<li><a href="userHome.jsp?type=caps">CAPS</a></li>
							<li><a href="userHome.jsp?type=t-shirts">T-SHIRTS</a></li>
							<li><a href="userHome.jsp?type=mugs">MUGS</a></li>
							<li><a href="userHome.jsp?type=badges">BADGES</a></li>
							<li><a href="userHome.jsp?type=cloth-bags">CLOTH-BAGS</a></li>
							<li><a href="userHome.jsp?type=other">SOME OTHER PRODUCTS</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=lanyards">LANYARDS</a></li>
							<li><a href="adminViewProduct.jsp?type=caps">CAPS</a></li>
							<li><a href="adminViewProduct.jsp?type=t-shirts">T-SHIRTS</a></li>
							<li><a href="adminViewProduct.jsp?type=mugs">MUGS</a></li>
							<li><a href="adminViewProduct.jsp?type=badges">BADGES</a></li>
							<li><a href="adminViewProduct.jsp?type=cloth-bags">CLOTH-BAGS</a></li>
							<li><a href="adminViewProduct.jsp?type=other">SOME OTHER PRODUCTS</a></li>
						</ul></li>
